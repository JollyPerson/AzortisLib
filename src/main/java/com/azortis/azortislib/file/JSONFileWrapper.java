...
public class JSONFileWrapper {
    ...
    public JSONFileWrapper(FileManager parent, String fileName, Object settingsMap, String settingsPath) {
        this.parent = parent;
    ...
    public void save() {
        Map<String, Object> parrentSettingsMap = parent.getJsonFileMap(fileName);
